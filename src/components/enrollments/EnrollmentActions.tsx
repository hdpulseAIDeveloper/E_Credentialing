...
const STATUS_TABS = ["Status & Decision", "Response Details"];
  ...
  return (
    <>
      <div className="flex gap-2">
        <button
          onClick={() => { setStatusOpen(true); setStatusTab(0); }}
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md mx-4">
              ...
              {STATUS_TABS.map((tab, i) => (
                <button
                  ...
                  className={`py-2 px-3 text-sm font-medium border-b-2 -mb-px transition-colors ${
                    statusTab === i ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700"
                  }`}
                >
                  {tab}
                </button>
            ...
            >
              ...
              <div className="px-6 pb-5 flex gap-3">
                {statusTab > 0 && (
                  <button type="button" onClick={() => setStatusTab((t) => t - 1)} className="px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors">
                    Back
                  </button>
                )}
                {statusTab < STATUS_TABS.length - 1 ? (
                  <button type="button" onClick={() => setStatusTab((t) => t + 1)} className="flex-1 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors">
                    Next: {STATUS_TABS[statusTab + 1]}
                  </button>
                ) : (
                ...
                <button type="button" onClick={() => setStatusOpen(false)} className="px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors">
                  Cancel
                </button>
              </div>
            </form>
