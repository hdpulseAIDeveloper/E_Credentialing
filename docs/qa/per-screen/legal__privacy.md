...
| Field | Value |
| --- | --- |
| Route(s) | `/legal/privacy` |
| Source file | `src/app/legal/privacy/page.tsx` |
| Dynamic | no |
| Group | public |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/public/legal__privacy.spec.ts`)._
