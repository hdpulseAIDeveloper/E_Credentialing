# Per-screen card: `/verify/carrier/[token]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/verify/carrier/[token]` |
| Source file | `src/app/verify/carrier/[token]/page.tsx` |
| Dynamic | yes |
| Group | public |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/public/verify__carrier__token.spec.ts`)._
