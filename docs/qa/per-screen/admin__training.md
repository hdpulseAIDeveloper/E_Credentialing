# Per-screen card: `/admin/training`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/training` |
| Source file | `src/app/(staff)/admin/training/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__training.spec.ts`)._
