...
| --- | --- |
| Route(s) | `/analytics` |
| Source file | `src/app/(staff)/analytics/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/analytics.spec.ts`)._
