...
| --- | --- |
| Route(s) | `/training` |
| Source file | `src/app/(staff)/training/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/training.spec.ts`)._
