...
| --- | --- |
| Route(s) | `/medicaid/[id]` |
| Source file | `src/app/(staff)/medicaid/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/medicaid__id.spec.ts`)._
