# Per-screen card: `/bots/exceptions/[id]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/bots/exceptions/[id]` |
| Source file | `src/app/(staff)/bots/exceptions/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/bots__exceptions__id.spec.ts`)._
