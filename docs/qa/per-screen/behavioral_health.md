# Per-screen card: `/behavioral-health`
...
| Field | Value |
| --- | --- |
| Route(s) | `/behavioral-health` |
| Source file | `src/app/(staff)/behavioral-health/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/behavioral_health.spec.ts`)._
