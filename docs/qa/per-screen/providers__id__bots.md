# Per-screen card: `/providers/[id]/bots`
...
| Field | Value |
| --- | --- |
| Route(s) | `/providers/[id]/bots` |
| Source file | `src/app/(staff)/providers/[id]/bots/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/providers__id__bots.spec.ts`)._
