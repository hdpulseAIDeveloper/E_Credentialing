...
| Field | Value |
| --- | --- |
| Route(s) | `/providers/[id]` |
| Source file | `src/app/(staff)/providers/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/providers__id.spec.ts`)._
