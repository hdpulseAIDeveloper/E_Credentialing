# Per-screen card: `/admin/settings`
...
| Source file | `src/app/(staff)/admin/settings/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__settings.spec.ts`)._
