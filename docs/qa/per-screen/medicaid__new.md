...
| Field | Value |
| --- | --- |
| Route(s) | `/medicaid/new` |
| Source file | `src/app/(staff)/medicaid/new/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/medicaid__new.spec.ts`)._
