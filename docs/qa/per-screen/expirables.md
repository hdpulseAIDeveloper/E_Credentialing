...
| --- | --- |
| Route(s) | `/expirables` |
| Source file | `src/app/(staff)/expirables/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/expirables.spec.ts`)._
