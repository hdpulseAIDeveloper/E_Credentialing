# Per-screen card: `/recredentialing`
...
| Field | Value |
| --- | --- |
| Route(s) | `/recredentialing` |
| Source file | `src/app/(staff)/recredentialing/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/recredentialing.spec.ts`)._
