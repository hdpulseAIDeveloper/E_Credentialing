...
| --- | --- |
| Route(s) | `/admin/users` |
| Source file | `src/app/(staff)/admin/users/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__users.spec.ts`)._
