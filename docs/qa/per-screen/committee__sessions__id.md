# Per-screen card: `/committee/sessions/[id]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/committee/sessions/[id]` |
| Source file | `src/app/(staff)/committee/sessions/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/committee__sessions__id.spec.ts`)._
