# Per-screen card: `/compliance/[framework]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/compliance/[framework]` |
| Source file | `src/app/(staff)/compliance/[framework]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/compliance__framework.spec.ts`)._
