# Per-screen card: `/admin/workflows/[id]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/workflows/[id]` |
| Source file | `src/app/(staff)/admin/workflows/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__workflows__id.spec.ts`)._
