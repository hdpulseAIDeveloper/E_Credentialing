# Per-screen card: `/verify/work-history/[token]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/verify/work-history/[token]` |
| Source file | `src/app/verify/work-history/[token]/page.tsx` |
| Dynamic | yes |
| Group | public |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/public/verify__work_history__token.spec.ts`)._
