...
| --- | --- |
| Route(s) | `/scorecards` |
| Source file | `src/app/(staff)/scorecards/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/scorecards.spec.ts`)._
