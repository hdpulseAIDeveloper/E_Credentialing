...
| --- | --- |
| Route(s) | `/fsmb-pdc` |
| Source file | `src/app/(staff)/fsmb-pdc/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/fsmb_pdc.spec.ts`)._
