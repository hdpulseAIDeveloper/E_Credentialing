...
| Field | Value |
| --- | --- |
| Route(s) | `/auth/register` |
| Source file | `src/app/auth/register/page.tsx` |
| Dynamic | no |
| Group | public |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/public/auth__register.spec.ts`)._
