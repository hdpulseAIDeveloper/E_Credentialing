...
| --- | --- |
| Route(s) | `/admin/roles` |
| Source file | `src/app/(staff)/admin/roles/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__roles.spec.ts`)._
