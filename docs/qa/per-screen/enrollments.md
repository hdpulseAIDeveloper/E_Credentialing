...
| --- | --- |
| Route(s) | `/enrollments` |
| Source file | `src/app/(staff)/enrollments/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/enrollments.spec.ts`)._
