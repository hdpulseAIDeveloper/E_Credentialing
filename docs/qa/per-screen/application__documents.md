# Per-screen card: `/application/documents`
...
| Field | Value |
| --- | --- |
| Route(s) | `/application/documents` |
| Source file | `src/app/(provider)/application/documents/page.tsx` |
| Dynamic | no |
| Group | provider |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/provider/application__documents.spec.ts`)._
