# Per-screen card: `/bots/exceptions`
...
| Field | Value |
| --- | --- |
| Route(s) | `/bots/exceptions` |
| Source file | `src/app/(staff)/bots/exceptions/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/bots__exceptions.spec.ts`)._
