...
| Field | Value |
| --- | --- |
| Route(s) | `/verifications` |
| Source file | `src/app/(staff)/verifications/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/verifications.spec.ts`)._
