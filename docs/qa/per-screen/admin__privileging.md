# Per-screen card: `/admin/privileging`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/privileging` |
| Source file | `src/app/(staff)/admin/privileging/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__privileging.spec.ts`)._
