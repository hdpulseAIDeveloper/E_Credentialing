# Per-screen card: `/admin/ai-governance`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/ai-governance` |
| Source file | `src/app/(staff)/admin/ai-governance/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__ai_governance.spec.ts`)._
