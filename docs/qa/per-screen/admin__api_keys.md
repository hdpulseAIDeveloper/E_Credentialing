# Per-screen card: `/admin/api-keys`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/api-keys` |
| Source file | `src/app/(staff)/admin/api-keys/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__api_keys.spec.ts`)._
