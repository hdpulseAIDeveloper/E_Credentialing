...
| Field | Value |
| --- | --- |
| Route(s) | `/legal/cookies` |
| Source file | `src/app/legal/cookies/page.tsx` |
| Dynamic | no |
| Group | public |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/public/legal__cookies.spec.ts`)._
