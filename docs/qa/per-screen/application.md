...
| --- | --- |
| Route(s) | `/application` |
| Source file | `src/app/(provider)/application/page.tsx` |
| Dynamic | no |
| Group | provider |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/provider/application.spec.ts`)._
