# Per-screen card: `/peer-review/[id]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/peer-review/[id]` |
| Source file | `src/app/(staff)/peer-review/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/peer_review__id.spec.ts`)._
