# Per-screen card: `/admin/workflows`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/workflows` |
| Source file | `src/app/(staff)/admin/workflows/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__workflows.spec.ts`)._
