# Per-screen card: `/committee/sessions/new`
...
| Field | Value |
| --- | --- |
| Route(s) | `/committee/sessions/new` |
| Source file | `src/app/(staff)/committee/sessions/new/page.tsx` |
| Dynamic | no |
| Group | staff |
| Roles allowed | ADMIN, MANAGER, COMMITTEE_MEMBER |
| Roles denied (must redirect/403) | SPECIALIST, PROVIDER (redirect to /dashboard) |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/committee__sessions__new.spec.ts`)._
