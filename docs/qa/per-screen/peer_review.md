...
| --- | --- |
| Route(s) | `/peer-review` |
| Source file | `src/app/(staff)/peer-review/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/peer_review.spec.ts`)._
