# Per-screen card: `/reports/export`
...
| Field | Value |
| --- | --- |
| Route(s) | `/reports/export` |
| Source file | `src/app/(staff)/reports/export/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/reports__export.spec.ts`)._
