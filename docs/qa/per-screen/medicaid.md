...
| --- | --- |
| Route(s) | `/medicaid` |
| Source file | `src/app/(staff)/medicaid/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/medicaid.spec.ts`)._
