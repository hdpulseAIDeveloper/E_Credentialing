...
| --- | --- |
| Route(s) | `/legal/terms` |
| Source file | `src/app/legal/terms/page.tsx` |
| Dynamic | no |
| Group | public |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/public/legal__terms.spec.ts`)._
