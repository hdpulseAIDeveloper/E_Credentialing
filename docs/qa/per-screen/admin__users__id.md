# Per-screen card: `/admin/users/[id]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/users/[id]` |
| Source file | `src/app/(staff)/admin/users/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__users__id.spec.ts`)._
