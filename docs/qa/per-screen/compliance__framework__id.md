# Per-screen card: `/compliance/[framework]/[id]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/compliance/[framework]/[id]` |
| Source file | `src/app/(staff)/compliance/[framework]/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/compliance__framework__id.spec.ts`)._
