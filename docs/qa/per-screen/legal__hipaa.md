...
| --- | --- |
| Route(s) | `/legal/hipaa` |
| Source file | `src/app/legal/hipaa/page.tsx` |
| Dynamic | no |
| Group | public |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/public/legal__hipaa.spec.ts`)._
