# Per-screen card: `/admin/ai-governance/[id]`
...
| Field | Value |
| --- | --- |
| Route(s) | `/admin/ai-governance/[id]` |
| Source file | `src/app/(staff)/admin/ai-governance/[id]/page.tsx` |
| Dynamic | yes |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/admin__ai_governance__id.spec.ts`)._
