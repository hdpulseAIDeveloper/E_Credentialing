...
| --- | --- |
| Route(s) | `/compliance` |
| Source file | `src/app/(staff)/compliance/page.tsx` |
| Dynamic | no |
| Group | staff |
...
_TODO: add per-screen specs as they're written (e.g. `tests/e2e/staff/compliance.spec.ts`)._
